...
from pipeline.blog_providers.base import BlogDraftProvider, clean_text
from pipeline.blog_providers.rule_based import RuleBasedBlogDraftProvider
...
def generate_blog_drafts_with_stats(
    ...
    for draft in drafts:
        ...
        if source_bundle_id == "fallback_bundle_1":
